...
public class UserRepositoryTests {
    ...
    void saveUserWithNullEmailShouldFailDatabaseConstraint() {
        User invalidUser = new User("Invalid User", null, "password");
    ...
    void findAllUsersWithPagination() {
        ...
        userRepository.saveAll(List.of(
                user,
                new User("User B", "b@example.com", "password"),
                new User("User C", "c@example.com", "password")
        ));
    ...
    void findAllUsersSortedByNameAscending() {
        User user = new User(TestData.NAME, TestData.EMAIL, TestData.PASSWORD);
        userRepository.saveAll(List.of(
                new User("John Doe", "john.doe@example.com", "password"),
                user,
                new User("Jane Doe", "jane.doe@example.com", "password")
        ));
